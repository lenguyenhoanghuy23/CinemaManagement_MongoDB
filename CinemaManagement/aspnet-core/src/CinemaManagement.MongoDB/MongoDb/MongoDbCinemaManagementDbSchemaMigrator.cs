...
public class MongoDbCinemaManagementDbSchemaMigrator : ICinemaManagementDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbCinemaManagementDbSchemaMigrator(IServiceProvider serviceProvider)
    {
